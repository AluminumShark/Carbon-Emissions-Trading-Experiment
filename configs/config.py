...
class ExperimentConfig:
    ...
    def __init__(self, config_file: str = "configs/experiment_config.yaml"):
        ...
        self._test_mode_enabled: bool | None = None
        self.load_config()
    ...
    def _get_default_config(self) -> dict[str, Any]:
        """獲取默認配置"""
        return {
            "experiment_mode": {"test_mode_enabled": False},
            "general": {
    ...
    def get_stage_initial_capital(self, stage: str) -> Any:
        """獲取階段初始資金"""
    ...
    @property
    def tax_rate_options(self) -> list[Any]:
        """碳稅率選項（Currency格式）"""
        from otree.api import cu
    ...
    @property
    def muda_initial_capital(self) -> Any:
        """MUDA初始資金"""
        from otree.api import cu
    ...
    @property
    def carbon_trading_initial_capital(self) -> Any:
        """碳交易初始資金"""
        from otree.api import cu
    ...
    def grandfathering_rule(self) -> dict[str, Any]:
        return self.get("stages.carbon_trading.optimal_allocation.grandfathering_rule", {})
    ...
    @property
    def market_price_options(self) -> list[Any]:
        """市場價格選項"""
        from otree.api import cu
