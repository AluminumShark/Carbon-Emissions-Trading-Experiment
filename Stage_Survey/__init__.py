...
class Player(BasePlayer):
    ...
    male = models.IntegerField(
        choices=[[1, "男"], [0, "女"]], label="您的性別為何？", widget=widgets.RadioSelectHorizontal
    )
    ...
    has_env_econ = models.IntegerField(
        label="您是否修過環境經濟學？", choices=[[1, "是"], [0, "否"]], widget=widgets.RadioSelectHorizontal
    )
    has_pub_econ = models.IntegerField(
        label="您是否修過公共經濟學？", choices=[[1, "是"], [0, "否"]], widget=widgets.RadioSelectHorizontal
    )
    has_exp_econ = models.IntegerField(
        label="您是否修過實驗經濟學？", choices=[[1, "是"], [0, "否"]], widget=widgets.RadioSelectHorizontal
    )
